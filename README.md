...
<div align="center">
  ...
  ![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=36BCF7&width=435&lines=Full+Stack+Developer;Open+Source+Enthusiast;Always+Learning+New+Things)
...
<!-- 
如果你想自定义更多选项，可以参考以下参数：

GitHub Stats Card 参数：
- hide: 隐藏特定统计 (issues,prs,commits,prs_merged,prs_merged_percentage)
...
Top Languages Card 参数：
- hide: 隐藏特定语言
- layout: 布局 (default, compact)
- card_width: 卡片宽度
- langs_count: 显示语言数量 (1-10)

更多信息请访问：https://github.com/anuraghazra/github-readme-stats
-->
